...
const PASSION_BODY = [
  "Vor sechs Jahren bin ich von Leverkusen nach Hamburg gezogen. Dort begann meine Ausbildung zur Illustrationsdesignerin an der HTK in Bahrenfeld, die ich Ende 2023 mit dem Diplom abgeschlossen habe. Nun habe ich beschlossen, meine Leidenschaft f\u00fcr Autos mit dieser Arbeit zu verschwei\u00dfen.",
